...
Freeware diagnostic and forensic security tool for Windows endpoints and networks. Features a friendly GUI and is suitable for both personal and organizational use.

Download the latest version [1.9.7](https://github.com/secuditor/secuditor-free/releases/download/1.9.0-series/SecuditorFree_1.9.7.zip)
